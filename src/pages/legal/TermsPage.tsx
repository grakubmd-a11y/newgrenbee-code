...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      pageTitle="Terms of Service | Greenbee"
      metaDescription="Read Greenbee's Terms of Service. Understand your rights and obligations when booking professional home services through our platform."
      lastUpdated="May 2026"
      intro="By using Greenbee's platform, website, or mobile experience, you agree to the following terms. Please read them carefully before booking any service."
      ...
      sections={[
        ...
        },
        {
          ...
          content: [
            ...
            "Greenbee does not directly employ Providers; all service relationships are governed by independent contractor terms.",
          ],
        },
        {
          ...
          content: [
            ...
            "Greenbee will use commercially reasonable efforts to fulfill bookings at the agreed time slot.",
        ...
        },
        {
          ...
          content: [
            ...
            "Greenbee reserves the right to adjust pricing with advance notice.",
          ],
        },
        {
        ...
        },
        {
          ...
          content:
            "To the fullest extent permitted by law, Greenbee's aggregate liability for any claim arising from or related to the platform or services shall not exceed the amount paid for the specific booking in question. Greenbee is not liable for indirect, incidental, or consequential damages.",
        },
        {
          title: "Intellectual Property",
          content:
            "All content, branding, code, and materials on the Greenbee platform are the exclusive property of Greenbee LLC and may not be reproduced, distributed, or used without prior written consent.",
        },
        {
          title: "Governing Law",
          content:
