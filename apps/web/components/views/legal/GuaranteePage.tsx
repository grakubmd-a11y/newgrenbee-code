...
export default function GuaranteePage() {
  ...
  return (
    <LegalPage
      title="Grenbee Satisfaction Guarantee"
      pageTitle="Satisfaction Guarantee | Grenbee"
      ...
      sections={[
        {
          title: "Our Promise",
          content:
            "Every Grenbee booking is backed by a 100% satisfaction guarantee. If the completed service does not meet the scope described at the time of booking, we will return to re-do the affected portion at no additional cost, or issue a partial refund at our discretion.",
        },
        {
          ...
          content: [
            ...
            "Damage to property caused directly by a Grenbee Provider while carrying out the booked service.",
        ...
        },
        {
          ...
          content:
            "All Grenbee Providers are required to carry general liability insurance with a minimum coverage of $1,000,000 per incident. Proof of insurance is verified during onboarding. For large damage claims, we will coordinate with the Provider's insurer on your behalf.",
        },
      ]}
    />
  );
